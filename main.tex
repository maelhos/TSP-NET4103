...
La pureté mesure à quel point le trait dominant est présent dans la communauté (à quelle point la secte est radicale\dots).

\begin{table}[h]
    \centering
    \begin{tabular}{|l|c|c|c|l|c|}
    \hline
    \textbf{Université} & \textbf{Rang} & \textbf{Conductance} & \textbf{Taille} & \textbf{Trait dominant} & \textbf{Pureté} \\ \hline
    \multirow{3}{*}{Caltech} 
